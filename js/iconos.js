...
const Iconos = {
  ...
  // 🟢 Usado en el botón fusionado "Ver Secciones y Parcelas"
  // (overlayCatastro.js) — el ícono de "capas" superpuestas representa
  // mejor la transición entre las dos capas que el de cuadraditos
  // (parcelas) que tenía antes el botón, ahora eliminado.
  capas: function() {
